...
-- In this data cleaning task, we have 4 main objectives ->
-- 1. Remove  duplicates
...
-- if these industries have multiple layoffs we can repopulate their null or blank industry value.
SELECT * 
FROM layoffs_staging2
